var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md @12sm" src="handWashing.png" alt="lavado de manos" class="svelte-1pl1cif">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-72aab3");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md @12sm");
    			attr(div1, "class", "progress-container svelte-72aab3");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\timer.svelte generated by Svelte v3.22.3 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-8m5vd2");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[0];
    			attr(button, "bp", "offset-5@md 4@md @12sm");
    			attr(button, "class", "start svelte-8m5vd2");
    			attr(div1, "bp", "grid");
    		},
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*secondsLeft*/ 2) set_data(t1, /*secondsLeft*/ ctx[1]);
    			const progressbar_changes = {};
    			if (dirty & /*progress*/ 4) progressbar_changes.progress = /*progress*/ ctx[2];
    			progressbar.$set(progressbar_changes);

    			if (!current || dirty & /*isRunning*/ 1) {
    				button.disabled = /*isRunning*/ ctx[0];
    			}
    		},
    		i(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		const timer = setInterval(
    			() => {
    				...
    				$$invalidate(1, secondsLeft -= 1);

    				if (secondsLeft == -1) {
    					clearInterval(timer);
    					$$invalidate(1, secondsLeft = totalSeconds);
    					$$invalidate(0, isRunning = false);
    					dispatch("end", { mensaje: "Hola" });
    				}
    			},
    			1000
    		);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 2) {
    			 $$invalidate(2, progress = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [isRunning, secondsLeft, progress, startTimer];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://vid.alarabiya.net/images/2020/03/22/1ff220bb-03ef-4911-b8e1-32f72eed355e/1ff220bb-03ef-4911-b8e1-32f72eed355e.PNG">Picture source</a> 
  <a href="https://english.alarabiya.net/en/coronavirus/2020/03/22/Coronavirus-Hand-washing-is-important-here-s-how-to-do-it-effectively">Sound source</a>`;
    			...
    			attr(h1, "class", "svelte-1l9xnyb");
    			attr(h3, "class", "svelte-1l9xnyb");
    		},
    		m(target, anchor) {
